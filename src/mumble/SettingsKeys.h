...
const SettingsKey ADAPTIVE_LOUDNESS_KEY                       = { "adaptive_loudness" };
const SettingsKey BASE_LOUDNESS_KEY                           = { "base_loudness" };
const SettingsKey ADAPTIVE_AMPLIFICATION_RNNOISE_KEY          = { "adaptive_amplification_rnnoise" };
const SettingsKey AMPLIFICATION_TARGETS_PEAK_KEY              = { "amplification_targets_peak" };
const SettingsKey AMPLIFICATION_RISE_MS_KEY                   = { "amplification_rise_ms" };
const SettingsKey AMPLIFICATION_FALL_MS_KEY                   = { "amplification_fall_ms" };
const SettingsKey AMPLIFICATION_VAD_MIN_KEY                   = { "amplification_vad_min" };
const SettingsKey AMPLIFICATION_VAD_MAX_KEY                   = { "amplification_vad_max" };
...
const SettingsKey NOISE_CANCEL_RESTORE_MODE_KEY               = { "noise_cancel_restore_mode" };
const SettingsKey SPEEX_NOISE_CANCEL_STRENGTH_KEY             = { "speex_noise_cancel_strength" };
const SettingsKey WEBRTC_NOISE_LEVEL_KEY                      = { "webrtc_noise_level" };
const SettingsKey WEBRTC_GAIN_CONTROL_KEY                     = { "webrtc_gain_control" };
const SettingsKey DEEP_FILTER_ATTEN_LIMIT_KEY                 = { "deep_filter_atten_limit" };
const SettingsKey DEEP_FILTER_POST_FILTER_KEY                 = { "deep_filter_post_filter" };
...
const SettingsKey ECHO_CANCEL_RESTORE_MODE_KEY                = { "echo_cancel_restore_mode" };
...
const SettingsKey TALKING_SILENT_ICON_KEY              = { "talking_silent_icon" };
const SettingsKey SILENCE_DETECTION_HOLD_KEY           = { "silence_detection_hold" };
...
const SettingsKey OVERLAY_SHOW_AVATAR_FRAME_KEY     = { "show_avatar_frame" };
const SettingsKey OVERLAY_ROUND_AVATAR_KEY          = { "round_avatar" };
const SettingsKey OVERLAY_HIDE_INAUDIBLE_KEY        = { "hide_inaudible_talkers" };
